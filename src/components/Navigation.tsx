...
// BEST if u want contact us as a button 
...
//             <button
//               onClick={() => onNavigate("contact")}
//               className={`px-6 py-1 rounded-full transition-colors duration-300 ${
//                 currentPage === "contact"
//                   ? "bg-white text-stone-700 px-5"
