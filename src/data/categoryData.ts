...
const categoryData = {
  ribbons: {
    ...
    subcategories: [
      ...
      { name: "WIRED VELVET", description: "Elegant velvet ribbons shaped with artistic precision.", imageUrl: "/products/ribbon/wired_velvet.png" },
      { name: "SHEER RIBBON", description: "Delicate transparency that whispers luxury.", imageUrl: "/products/ribbon/sheer_ribbon.png" },
      ...
      { name: "ABSTRACT POLY", description: "Modern geometry for contemporary creations.", imageUrl: "/products/ribbon/abstract_poly.png" },
  ...
  trims: {
    ...
    subcategories: [
      ...
      { name: "POMS", description: "Soft pom-poms that add whimsy and fun.", imageUrl: "/products/trims/poms.png" },
      { name: "CORDS", description: "Elegant cords to tie your vision together.", imageUrl: "/cover-images/cord cover.png" },
      { name: "RUFFLED & PLEATED", description: "Romantic folds full of movement and grace.", imageUrl: "/products/trims/pleated&ruffled.png" },
      { name: "FRINGES & TASSELS", description: "Free-flowing details that bring texture alive.", imageUrl: "/products/trims/fringes&tassels.png" },
      { name: "LACES", description: "Delicate lace trims woven with elegance.", imageUrl: "/products/trims/laces.png" },
    ],
  },
